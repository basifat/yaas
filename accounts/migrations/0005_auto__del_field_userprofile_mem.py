...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.mem'
        db.delete_column(u'accounts_userprofile', 'mem')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserProfile.mem'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.mem' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'UserProfile.mem'
        db.add_column(u'accounts_userprofile', 'mem',
                      self.gf('django.db.models.fields.CharField')(max_length=140),
                      keep_default=False)
