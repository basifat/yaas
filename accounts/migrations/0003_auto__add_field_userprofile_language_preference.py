...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.language_preference'
        db.add_column(u'accounts_userprofile', 'language_preference',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=140),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.language_preference'
        db.delete_column(u'accounts_userprofile', 'language_preference')
