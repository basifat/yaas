...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'auctions_auction', (
            ...
            ('bidders', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bids.Bid'])),
            ...
            ('deadline', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 11, 9, 0, 0))),
    ...
    models = {
        u'auctions.auction': {
            ...
            'bidders': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bids.Bid']"}),
