...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'auctions_bid', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
        # Deleting field 'Auction.last_bid_by'
        db.delete_column(u'auctions_auction', 'last_bid_by')


        # Changing field 'Auction.seller'
        db.alter_column(u'auctions_auction', 'seller_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Bid.user'
        db.alter_column(u'auctions_bid', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # User chose to not deal with backwards NULL issues for 'Auction.last_bid_by'
        raise RuntimeError("Cannot reverse this migration. 'Auction.last_bid_by' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Auction.last_bid_by'
        ...
        # Changing field 'Auction.seller'
        db.alter_column(u'auctions_auction', 'seller_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
    ...
    models = {
        u'auctions.auction': {
            ...
            'seller': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
