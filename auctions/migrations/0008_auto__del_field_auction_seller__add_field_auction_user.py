...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Auction.seller'
        db.delete_column(u'auctions_auction', 'seller_id')

        # Adding field 'Auction.user'
        db.add_column(u'auctions_auction', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Auction.seller'
        db.add_column(u'auctions_auction', 'seller',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Auction.user'
        db.delete_column(u'auctions_auction', 'user_id')
