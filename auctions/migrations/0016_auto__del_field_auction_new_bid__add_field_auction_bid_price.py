...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Auction.new_bid'
        db.delete_column(u'auctions_auction', 'new_bid')

        # Adding field 'Auction.bid_price'
        db.add_column(u'auctions_auction', 'bid_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0.01, max_digits=100, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Auction.new_bid'
        db.add_column(u'auctions_auction', 'new_bid',
                      self.gf('django.db.models.fields.DecimalField')(default=0.01, max_digits=100, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Auction.bid_price'
        db.delete_column(u'auctions_auction', 'bid_price')
    ...
    models = {
        u'auctions.auction': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 8, 0, 0)'}),
