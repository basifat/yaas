...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'auctions_bid', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='bidder', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'auctions.bid': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'bidder'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"})
        },
        u'auth.group': {
