...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bid.previous_bid'
        db.add_column(u'auctions_bid', 'previous_bid',
                      self.gf('django.db.models.fields.DecimalField')(default=0.01, max_digits=100, decimal_places=2),
                      keep_default=False)

        # Adding field 'Bid.bid_version'
        db.add_column(u'auctions_bid', 'bid_version',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bid.previous_bid'
        db.delete_column(u'auctions_bid', 'previous_bid')

        # Deleting field 'Bid.bid_version'
        db.delete_column(u'auctions_bid', 'bid_version')
