...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Auction.bidders'
        db.delete_column(u'auctions_auction', 'bidders_id')

        # Adding field 'Auction.bidder'
        db.add_column(u'auctions_auction', 'bidder',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['bids.Bid']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Auction.bidders'
        raise RuntimeError("Cannot reverse this migration. 'Auction.bidders' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Auction.bidders'
        db.add_column(u'auctions_auction', 'bidders',
    ...
    models = {
        u'auctions.auction': {
            ...
            'bidder': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bids.Bid']"}),
        ...
        u'bids.bid': {
            ...
            'bidder': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'bidlist': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
