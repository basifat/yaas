...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Auction.last_bidderr'
        db.delete_column(u'auctions_auction', 'last_bidderr')

        # Adding field 'Auction.last_bidder'
    ...
    def backwards(self, orm):
        # Adding field 'Auction.last_bidderr'
        db.add_column(u'auctions_auction', 'last_bidderr',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=120),
                      keep_default=False)
    ...
    models = {
        u'auctions.auction': {
            ...
            'last_bidder': ('django.db.models.fields.CharField', [], {'max_length': '120'}),
