...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'auctions_auction', 'bid_version',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'auctions_auction', 'bid_version')
    ...
    models = {
        u'auctions.auction': {
            ...
            'new_bid': ('django.db.models.fields.DecimalField', [], {'default': '0.01', 'max_digits': '100', 'decimal_places': '2'}),
