...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Auction.current_winning_bidder'
        db.add_column(u'auctions_auction', 'current_winning_bidder',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Auction.current_winning_bidder'
        db.delete_column(u'auctions_auction', 'current_winning_bidder')
    ...
    models = {
        u'auctions.auction': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 12, 0, 0)'}),
